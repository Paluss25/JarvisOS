...
from agents.nutrition.models import ConfirmationStatus, FusedResult, MealRecord, SourceType
        ...
        for item in fused.items:
            await conn.execute(
                ...
                INSERT INTO meal_items (
                    ...
                    portion_g, calories, protein_g, carbs_g, fat_g,
        ...
        for item in fused.items:
            await conn.execute(
                ...
                INSERT INTO food_library (
                    canonical_name, source_database,
                    calories_per_100g, protein_per_100g, carbs_per_100g, fat_per_100g,
                    use_count, last_used
                ) VALUES ($1, $2, $3, $4, $5, $6, 1, NOW())
                ON CONFLICT (canonical_name, source_database) DO UPDATE

...
_UNIT_TEST_FILES = {
    ...
    "test_open_loop_registry.py",
    "test_mt_plane_tools.py",
    "test_plane_cli.py",
    ...
    "test_send_message_aliases.py",
    "test_task_tools_plugin.py",
    "test_inbox_retry.py",
